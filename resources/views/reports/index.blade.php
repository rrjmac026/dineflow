        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="text-lg font-medium text-amber-900 dark:text-amber-100 mb-4">
                            <i class="fas fa-chart-line mr-2"></i>Sales Report
                        </h3>
                        <p class="text-gray-600 dark:text-gray-400 mb-4">Generate detailed sales reports with filters for date ranges.</p>
                        <form action="{{ route('reports.sales') }}" method="GET" class="space-y-4">
                            ...
                            <button type="submit" class="w-full inline-flex justify-center items-center px-4 py-2 bg-amber-600 hover:bg-amber-700 text-white rounded-md">
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 dark:text-gray-400 mb-4">Generate current inventory status report with stock levels.</p>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 dark:text-gray-400 mb-4">Generate customer feedback and ratings report.</p>
