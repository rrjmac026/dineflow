<x-app-layout>
    ...
    <div class="flex justify-end px-8 mt-4">
        <a href="{{ route('orders.create') }}" class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-amber-600 hover:bg-amber-700 dark:bg-amber-500 dark:hover:bg-amber-600 rounded-lg transition-colors duration-200">
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full table-auto">
                            ...
                            <tbody class="divide-y divide-amber-200 dark:divide-amber-700">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="py-4 px-6 text-sm text-center text-gray-500 dark:text-gray-400">
                                            No orders found
                                        </td>
                                    </tr>
                                @endforelse
