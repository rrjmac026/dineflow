...
<head>
    ...
    <title>Super Admin Register - DineFlow</title>
    ...
    <div class="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
        <div class="glass-effect w-full max-w-md p-6 sm:p-8 rounded-xl">
            ...
            <div class="flex flex-col items-center mb-8">
                ...
                <h2 class="text-2xl font-bold text-white tracking-tight">Create Super Admin</h2>
                <p class="mt-2 text-sm text-white/80">Register new administrator account</p>
            </div>

            <form method="POST" action="{{ route('superadmin.register') }}" class="space-y-6">
                @csrf
