        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('menu.update', $menu) }}" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <select id="category" name="category" 
                                        ...
                                        @foreach(['main' => 'Main Course', 'appetizer' => 'Appetizer', 'dessert' => 'Dessert', 'beverage' => 'Beverage'] as $value => $label)
